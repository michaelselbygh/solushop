                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="card-footer" style="text-align: center; padding-bottom:0px;">
                                ...
                                <hr>
                                <form method="POST" onsubmit="submitButton.disabled = true; return true;" action="{{ route("sales-associate.process.add.order", [$order["customer"]["id"], $order["address"]["id"]]) }}">
                                    @csrf
                                    ...
                                    <div class="form-actions center">
                                        ...
                                        <button type="submit" name='initiateOrder' id="submitButton" class="btn btn-success  mr-1">
