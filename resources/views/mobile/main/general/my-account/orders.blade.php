                            ...
                            @foreach ($orders as $order)
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-item-content">
                                        <br>
                                        <div class="row">
                                            <div class="col-20" style="padding-right:0px; padding-left:0px; ">
                                            </div>
                                            <div class="col-80" style="padding-right:0px; padding-left:0px; text-align:right;">
                                                <h6>Status - <b>
                                                ...
                                                <h6 style="font-size: 13px">Payment - 
                                                    <b>
