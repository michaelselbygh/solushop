                    ...
                    <div class="wrap-content">
                        ...
                        <div class="information-product-wrapper section-wrapper">   
                            ...
                            <ul>
                                ...
                                <li>Payment 
                                    <span>
                                        @if ($product['pay_on_delivery'] == 0) 
                                            <span style='font-weight: 450'>On Delivery</span>
                                        @else
                                            <span style='font-weight: 450'>Before Delivery</span>
                                        @endif
                                    </span>
                                </li>
                        ...
                        <div class="author-wrapper">
                            ...
                            <img class='lazy' data-src="{{ url('app/assets/img/icon/vendor.png') }}" alt="">
                                        ...
                                        @if($product["related_products"][$i]["id"] != $product["id"]) 
                                            <div class="swiper-slide">
                                                <a href="{{ url('shop/'.$product['related_products'][$i]['vendor']['username'].'/'.$product['related_products'][$i]['product_slug'])}}" class="external">
                                                    <div class="content">
                                                        <img class='lazy' data-src="{{ url('app/assets/img/products/thumbnails/'.$product['related_products'][$i]['images'][0]['pi_path'].'.jpg') }}" alt="">
                                                        <div class="text">
                        ...
                        <div class="container">
                            <div class="review-product-wrapper section-wrapper">
                                ...
                                @if(sizeof($product["reviews"]) > 0 AND !(sizeof($product["reviews"]) == 1 AND $product['signed_in_customer_review'] == 0))
                                    ...
                                    <div class="content">
                                        <img class='lazy' data-src="{{ url('/app/assets/img/comment-author/2.png') }}" alt="">
                                        <div class="text">
