                            ...
                            <form method="POST" action="{{ route("process.cart.action") }}">
                                            ...
                                            <div class="col-25">
                                                <div class="content-image">
                                                    <a href="{{ url("shop/".$cart["cart_items"][$i]["username"]."/".$cart["cart_items"][$i]["product_slug"]) }}" class="external">
                                                        <img class='lazy' data-src="{{ url("app/assets/img/products/thumbnails/".$cart["cart_items"][$i]["product_images"][0]["pi_path"].".jpg") }}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-55">
                                ...
                                <div class="wrap-content">
                                        <div class="row">
                                            <div class="col-25">
                                                <div class="content-image">
                                                    <img class='lazy' data-src="{{ url("app/assets/img/discount-badges/Rookie.png") }}" alt="">
                                                </div>
                                            </div>
                                            <div class="col-55">
                                                <div class="content-text">
