                                    ...
                                    @for ($j = 0; $j < sizeof($sections['products'][$i]); $j++)
                                        <div class="swiper-slide">
                                            <a href="{{ url('shop/'.$sections['products'][$i][$j]['vendor']['username'].'/'.$sections['products'][$i][$j]['product_slug'])}}" class="external">
                                                <div class="content">
                                                    <img class='lazy' data-src="{{ url('app/assets/img/products/thumbnails/'.$sections['products'][$i][$j]['images'][0]['pi_path'].'.jpg') }}" alt="{{ ucwords($sections['products'][$i][$j]['product_name']) }}">
                                                    <div class="text">
                                                        <a href="{{ url('shop/'.$sections['products'][$i][$j]['vendor']['username'].'/'.$sections['products'][$i][$j]['product_slug'])}}" class="external">
