                        ...
                        <div class="container">
                            <div class="row">
                                <div class="content section-wrapper" style="min-height:0px;">
                                    <img class='lazy' data-src="{{ url('app/assets/img/vendor-banner/'.$vendor['id'].'.jpg') }}" alt="">
                                </div>
                                @for ($i = 0; $i < sizeof($vendor['products']); $i++)
                                    ...
                                    <div class="col-50">
                                        <a href="{{ url('shop/'.$vendor['username'].'/'.$vendor['products'][$i]['product_slug'])}}" class="external">
                                            <div class="content">
                                                <img class='lazy' data-src="{{ url('app/assets/img/products/thumbnails/'.$vendor['products'][$i]['images'][0]['pi_path'].'.jpg') }}" alt="">
                                                <div class="text">
                                                    <a href="{{ url('shop/'.$vendor['username'].'/'.$vendor['products'][$i]['product_slug'])}}" class="external">
