                        ...
                        <div class="container">
                            <div class="accordion-list">                    
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-item-content">
                                        <br>
                                        <form id="checkout-form" method="POST" action="{{ route('process.checkout') }}" style="text-align: center;">
                                                @csrf
                                                <input type="hidden" name="checkout_action" value="process_checkout"/>
                                                <div id="radioBtn" class="btn-group">
                                                    @if($checkout['payment_type'] == 1)
                                                        <a class="btn rbtn btn-sm active" data-toggle="paymentType" data-title="on_delivery">
                                                            Cash On Delivery
                                                        </a>
                                                        <a class="btn rbtn btn-sm notActive" data-toggle="paymentType" data-title="before_delivery">
                                                            Online Before Delivery 
                                                        </a>
                                                    @else
                                                        <a class="btn rbtn btn-sm active" data-toggle="paymentType" data-title="before_delivery">
                                                            Online Before Delivery 
                                                        </a>
                                                    @endif
                                ...
                                <button class="button" style="background-color:green" onclick="document.getElementById('checkout-form').submit();">Place Order
