        ...
        <div class="tabs page-content">
            <div id="tab-1" class="tab tab-active">
                ...
                <div class="about segments-page">
                    <div class="container">
                        <div class="content">
                            <img class='lazy' data-src="{{ url('app/assets/img/about/2.jpg') }}" style="border-radius:20px; width:100%"><br>
                            ...
                            <img class='lazy' data-src="{{ url('app/assets/img/about/1.jpg') }}" style="border-radius:20px; width:100%">
                            ...
                            <img class='lazy' data-src="{{ url('app/assets/img/about/3.jpg') }}" style="border-radius:20px; width:100%"><br>
                            ...
                            <img class='lazy' data-src="{{ url('app/assets/img/about/4.jpg') }}" style="border-radius:20px; width:100%"><br>
