                                                            ...
                                                            <div class="col-4">
                                                                <div class="product-img">
                                                                    <a href="{{ url('shop/'.$featured_products[$i]['vendor']['username'].'/'.$featured_products[$i]['product_slug']) }}">
                                                                        <img class="lazy first-img" data-src="{{ url('app/assets/img/products/thumbnails/'.$featured_products[$i]['images'][0]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                                                        @if (sizeof($featured_products[$i]['images']) > 1) 
                                                                            <img class="lazy hover-img" data-src="{{ url('app/assets/img/products/thumbnails/'.$featured_products[$i]['images'][1]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                                                        @endif
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="single-product" style=' text-align:center;'>
                                                        <div class="product-img">
                                                            <a href="{{ url('shop/'.$sections['products'][$i][$j]['vendor']['username'].'/'.$sections['products'][$i][$j]['product_slug'])}}">
                                                                <img class="lazy first-img" data-src="{{ url('app/assets/img/products/thumbnails/'.$sections['products'][$i][$j]['images'][0]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">

                                                                @if (sizeof($sections['products'][$i][$j]['images']) > 1) 
                                                                    <img class="lazy hover-img" data-src="{{ url('app/assets/img/products/thumbnails/'.$sections['products'][$i][$j]['images'][1]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                                                @endif
