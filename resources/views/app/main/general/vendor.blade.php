                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="shop-product-img mb-10 img-full">
                                    <img class='lazy' style="border-radius:20px;" data-src="{{ url('app/assets/img/vendor-banner/'.$vendor['id'].'.jpg') }}"  alt="">
                                </div>
                            </div>
                            <!--Shop Product Image Start-->
                        </div>
                ...
                <div class="col-md-3 col-sm-3" style='text-align: center;'>
                    <div class='single-product-quantity' style=' padding: 10px; border-radius: 10px; min-height: 240px; line-height: 16px; background: #f7f7f7 !important; margin-bottom:20px;'>
                        <h4 style='text-align: center; font-size: 14px;'>
                            <img class='lazy' data-src='{{ url('app/assets/img/icon/vendor.png') }}' style='width:60px; height:auto'/>
                            <br>
                                                    ...
                                                    <div class="single-product" style='height:290px; text-align:center;'>
                                                        <div class="product-img">
                                                            <a href="{{ url('shop/'.$vendor['products'][$i]['vendor']['username'].'/'.$vendor['products'][$i]['product_slug']) }}">
                                                                <img class="lazy first-img" data-src="{{ url('app/assets/img/products/thumbnails/'.$vendor['products'][$i]['images'][0]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                                                @if (sizeof($vendor['products'][$i]['images']) > 1) 
                                                                    <img class='lazy hover-img' data-src="{{ url('app/assets/img/products/thumbnails/'.$vendor['products'][$i]['images'][1]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                                                @endif
