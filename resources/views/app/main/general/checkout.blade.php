        ...
        <div class="container" style="text-align:center">
            <div class="row" style="display: inline-block; width:80%">
                <div class="col-md-6">
                    ...
                    <form id="checkout-form" method="POST" action="{{ route('process.checkout') }}" style="text-align: left;">
                        @csrf
                        ...
                        <div class="checkout-form-area">
                            <div class="ceckout-form">
                                ...
                                <div class="checkout-payment">
                                    <button class="order-btn" onclick="document.getElementById('checkout-form').submit();">Place Order
                                    </button>
                                </div>
                            </div>
                        </div>
