        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6" style="text-align: right;">
                    <img class='lazy' data-src="{{ url('app/assets/img/about/2.jpg') }}" style="border-radius:20px; width:350px;" />
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6" style="text-align: left;">
                    <img class='lazy' data-src="{{ url('app/assets/img/about/1.jpg') }}" style="border-radius:20px; width: 350px;" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6" style="text-align: right;">
                    <img class='lazy' data-src="{{ url('app/assets/img/about/3.jpg') }}" style="border-radius:20px;  width: 350px;" />
                </div>
                <div class="col-md-6 col-sm-6" style="text-align: left;">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6" style="text-align: left;  width: 350px;">
                    <img class='lazy' data-src="{{ url('app/assets/img/about/4.jpg') }}" style="border-radius:20px;" />
                </div>
            </div>
            <br><br>
        </div>
