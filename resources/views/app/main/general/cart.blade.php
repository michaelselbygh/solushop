                        ...
                        <table style="width: 80%; margin:auto;">
                            ...
                            <tbody>
                                <form id="update-cart-form" method="POST" action="{{ route("process.cart.action") }}">
                                        ...
                                        <tr>
                                            <td class="product-name" style='text-align:left;'>
                                                <a href="{{ url("shop/".$cart["cart_items"][$i]["username"]."/".$cart["cart_items"][$i]["product_slug"]) }}">
                                                    <img class='lazy' data-src="{{ url("app/assets/img/products/thumbnails/".$cart["cart_items"][$i]["product_images"][0]["pi_path"].".jpg") }}" width='60px;' height='auto' style='border-radius:5px;' alt="">
                                                    &nbsp;&nbsp;
                                    ...
                                    <tr>
                                            <td class="product-name" style='text-align:left;'>
                                                <img class='lazy' data-src="{{ url("app/assets/img/discount-badges/Rookie.png") }}" width='60px;' height='auto' style='border-radius:5px;' alt="">
                                                &nbsp;&nbsp;
