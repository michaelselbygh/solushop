                                                    ...
                                                    <div class="single-product" style='height:290px; text-align:center;'>
                                                        <div class="product-img">
                                                            <a href="{{ url('shop/'.$product[$i]['vendor']['username'].'/'.$product[$i]['product_slug']) }}">
                                                                <img class='lazy first-img' data-src="{{ url('app/assets/img/products/thumbnails/'.$product[$i]['images'][0]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                                                @if (sizeof($product[$i]['images']) > 1) 
                                                                    <img class='lazy hover-img' data-src="{{ url('app/assets/img/products/thumbnails/'.$product[$i]['images'][1]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                                                @endif
