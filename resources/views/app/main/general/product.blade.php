...
@section('page-image'){{ url('/app/assets/img/products/main/'.$product['images'][0]['pi_path'].'.jpg') }}@endsection
                ...
                <div class="single-product-info mb-50">
                            ...
                            <div id="w1" class="tab-pane fade in active">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="{{ url('/app/assets/img/products/main/'.$product['images'][0]['pi_path'].'.jpg') }}">
                                        <img class='lazy' data-src="{{ url('/app/assets/img/products/main/'.$product['images'][0]['pi_path'].'.jpg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div id="w{{ $i + 1 }}" class="tab-pane fade">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="{{ url('/app/assets/img/products/main/'.$product['images'][$i]['pi_path'].'.jpg') }}">
                                            <img class='lazy' data-src="{{ url('/app/assets/img/products/main/'.$product['images'][$i]['pi_path'].'.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            @endfor
                            ...
                            <div class="single-product-tab">
                                <div class="single-product-tab-menu owl-carousel"> 
                                    <a data-toggle="tab" href="#w1">
                                        <img class='lazy' data-src="{{ url('/app/assets/img/products/thumbnails/'.$product['images'][0]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                    </a>
                                    @for ($i = 1; $i < sizeof($product['images']); $i++)
                                        <a data-toggle="tab" href="#w{{ $i + 1 }}"><img class='lazy' data-src="{{ url('/app/assets/img/products/thumbnails/'.$product['images'][$i]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                        </a>
                                    @endfor
                                </div>
                            </div>
                                            ...
                                            @if (Auth::check()) 
                                                <div class="bts-popup" role="alert" >
                                                    <div class="bts-popup-container"style='background-color:white;'>
                                                        <img class='lazy' data-src="{{ url('app/assets/img/caution.png') }}" alt="" width="35%" />
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="single-product-quantity" style=" padding: 10px; border-radius: 10px; line-height: 16px; background: #f7f7f7 !important;">
                            ...
                            <li>
                                <i class='fa fa-money' style='font-size:14px; margin-right:3px; color: #f68b1e;'></i>
                                @switch($product['pay_on_delivery'])
                                    @case(1)
                                        <span style="font-size: 10px; font-weight: 450">Pay Before Delivery</span>
                                        @break
                                    @case(0)
                                        <span style="font-size: 10px; font-weight: 450">Pay On Delivery</span>
                                        @break
                                    @default 
                                @endswitch
                        ...
                        <a style='color:#f68b1e' href="{{ url('shop/'.$product['vendor']['username']) }}">
                            <div class='single-product-quantity' style=' padding: 10px; border-radius: 10px; line-height: 16px; background: #f7f7f7 !important; margin-bottom:20px;'>
                                <h4 style='text-align: center; font-size: 14px;'>
                                    <img class='lazy' data-src='{{ url('app/assets/img/vendor-banner/'.$product['product_vid'].'.jpg') }}' style='width:100%; height:auto; border-radius: 5px;'/>
                                    <br><br>
                                ...
                                <div class="col-md-12">
                                    <div class="single-product">
                                        ...
                                        <a href="{{ url('shop/'.$product['related_products'][$i]['vendor']['username'].'/'.$product['related_products'][$i]['product_slug'])}}">
                                            <img class="lazy first-img" data-src="{{ url('app/assets/img/products/thumbnails/'.$product['related_products'][$i]['images'][0]['pi_path'].'.jpg') }}" style='border-radius:10px;' alt="">
                                ...
                                @for($i=0; $i < sizeof($product["reviews"]); $i++)
                                    ...
                                    <li>
                                        <div class="product-comment" >
                                                <img class='lazy' data-src="{{ url('/app/assets/img/comment-author/2.png') }}" class='comment-img' alt="">
